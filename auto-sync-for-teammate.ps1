# Auto pull & push every 30 seconds - for Focus Fee collaboration
# 
# SETUP:
# 1. Save this file as auto-pull.ps1 in your project folder (e.g. c:\...\focus_fee\)
# 2. Open PowerShell in that folder
# 3. Run: .\auto-pull.ps1
# 4. Press Ctrl+C to stop
#
# This will sync your changes with the repo every 30 seconds.
